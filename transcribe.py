...
def get_url():
    ...
    #        "?model=au-syd_BroadbandModel").format(host)
    return "wss://api.kr-seo.speech-to-text.watson.cloud.ibm.com/instances/cf0e1424-ba88-4a39-86d9-7214b706f0cb/v1/recognize?model=ko-KR_BroadbandModel"
