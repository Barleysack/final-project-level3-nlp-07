...
from encoder import DLSTMPEncoder


class OnDeviceRNNT(TransducerModel):
    """
    ...
    def __init__(
        ...
        super(OnDeviceRNNT, self).__init__(encoder, decoder, output_dim, num_classes)
